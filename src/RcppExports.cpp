...
RcppExport SEXP _localRWR_Cpp_rowSums(SEXP xSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _localRWR_Cpp_colSums(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericMatrix& >::type x(xSEXP);
...
RcppExport SEXP _localRWR_Arma_Inv(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _localRWR_rwr_cpp(SEXP adj_matSEXP, SEXP init_scoresSEXP, SEXP int_scoresSEXP, SEXP restart_propSEXP, SEXP num_iterSEXP, SEXP deltaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_localRWR_Cpp_rowSums", (DL_FUNC) &_localRWR_Cpp_rowSums, 1},
    {"_localRWR_Cpp_colSums", (DL_FUNC) &_localRWR_Cpp_colSums, 1},
    {"_localRWR_Arma_Inv", (DL_FUNC) &_localRWR_Arma_Inv, 1},
    {"_localRWR_rwr_cpp", (DL_FUNC) &_localRWR_rwr_cpp, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_localRWR(DllInfo *dll) {
